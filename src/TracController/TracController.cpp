...
// C/C++ source code generated on  : 13-Nov-2024 13:48:53
//
...
//
// MATLAB Coder version            : 24.1
// C/C++ source code generated on  : 13-Nov-2024 13:56:44
//
                    ...
                    const double param[4], double t, double u[3])
{
  ...
  Ts1_idx_1 = (x[7] - b_Ts1_idx_1_tmp * b_Ts1_tmp * Ts1_tmp_tmp) -
              Ts1_idx_1_tmp * b_Ts1_tmp_tmp * Ts1_tmp;
  yr_tmp_tmp = 3.1415926535897931 * t / 8.0;
  yr_tmp = std::sin(yr_tmp_tmp);
  b_yr_tmp = std::cos(yr_tmp_tmp);
  yr_tmp_tmp = 3.1415926535897931 * t / 4.0;
  n2 = std::sin(yr_tmp_tmp);
  c_yr_tmp = std::cos(yr_tmp_tmp);
  n3_tmp = param[2] * b_Ts1_tmp_tmp;
  n3 = (0.0 - Kv[0] * Ts1_idx_1) -
       Kv[3] * ((x[2] + n3_tmp * Ts1_tmp_tmp) - -0.4);
  n3p = (0.0 - Kv[0] * n3) - Kv[3] * Ts1_idx_1;
  n3pp = (0.0 - Kv[0] * n3p) - Kv[3] * n3;
  yr_tmp_tmp = param[3] - n3;
  n1_tmp = b_Ts1_tmp_tmp * b_Ts1_tmp_tmp;
  b_n1_tmp = Ts1_tmp_tmp * Ts1_tmp_tmp;
  Ts1_idx_1 = b_Ts1_tmp * x[8];
  n1 = (((0.035672274548584869 * yr_tmp -
          Kv[1] * (((n3p * Ts1_tmp_tmp * Ts1_tmp - x[9] * yr_tmp_tmp) *
                        b_Ts1_tmp_tmp -
                    Ts1_idx_1 * Ts1_tmp_tmp * Ts1_tmp * yr_tmp_tmp) /
                       n1_tmp / b_n1_tmp -
                   -0.090838701211815864 * b_yr_tmp)) -
         Kv[4] * (-Ts1_tmp * yr_tmp_tmp / Ts1_tmp_tmp / b_Ts1_tmp_tmp -
                  -0.23131885315053183 * yr_tmp)) -
        Kv[7] * ((x[5] + Ts1_idx_1_tmp * Ts1_tmp_tmp) -
                 0.58904862254808621 * b_yr_tmp)) -
       Kv[10] * ((x[0] + param[2] * Ts1_tmp) - 1.5 * yr_tmp);
  n2 = (((0.28537819638867895 * n2 -
          Kv[2] *
              ((-n3p * b_Ts1_tmp * b_Ts1_tmp_tmp + x[8] * yr_tmp_tmp) / n1_tmp -
               -0.36335480484726346 * c_yr_tmp)) -
         Kv[5] * (b_Ts1_tmp * yr_tmp_tmp / b_Ts1_tmp_tmp -
                  -0.46263770630106366 * n2)) -
        Kv[8] * (((x[6] - b_Ts1_idx_1_tmp * b_Ts1_tmp_tmp * Ts1_tmp_tmp) +
                  Ts1_idx_1_tmp * b_Ts1_tmp * Ts1_tmp) -
                 0.58904862254808621 * c_yr_tmp)) -
       Kv[11] * ((x[1] - param[2] * b_Ts1_tmp * Ts1_tmp_tmp) - 0.75 * n2);
  a_tmp = -param[3] + n3;
  u_tmp = x[8] * x[8];
  b_u_tmp = rt_powd_snf(Ts1_tmp_tmp, 3.0);
  c_u_tmp = x[9] * x[9];
  ...
  u[0] =
      (((n3_tmp * ((n1_tmp * n3pp - b_Ts1_tmp_tmp * b_Ts1_tmp * n2) + e_u_tmp) *
       ...
       2.0 * b_n1_tmp *
           (-b_n1_tmp * n1_tmp * n1 / 2.0 +
            (b_Ts1_tmp_tmp * n3p + Ts1_idx_1 * a_tmp) * x[9]) *
           param[2] * param[0]) /
      a_tmp / Ts1_tmp_tmp / b_Ts1_tmp_tmp;
  Ts1_idx_1 = rt_powd_snf(Ts1_tmp_tmp, 4.0);
  yr_tmp = rt_powd_snf(b_Ts1_tmp_tmp, 3.0);
  b_yr_tmp = 0.66666666666666663 * u_tmp;
  c_yr_tmp = c_u_tmp + b_yr_tmp;
  yr_tmp_tmp = Ts1_idx_1_tmp * x[8] * Ts1_tmp;
  u[1] =
      ((((-b_Ts1_tmp_tmp * param[2] * param[0] *
              (((yr_tmp * n2 + n1_tmp * b_Ts1_tmp * n3pp) -
                n2 * b_Ts1_tmp_tmp) +
         ...
         3.0 * b_Ts1_tmp_tmp * param[2] * param[0] *
             ((0.66666666666666663 * n3p * x[8] + n2 / 3.0) * b_Ts1_tmp_tmp +
              c_yr_tmp * b_Ts1_tmp * a_tmp) *
             b_n1_tmp) +
        ((-4.0 * param[2] * x[9] * x[8] * Ts1_tmp * param[0] * a_tmp * n1_tmp +
          2.0 * param[2] * x[9] * Ts1_tmp * b_Ts1_tmp_tmp * b_Ts1_tmp *
              param[0] * n3p) +
         2.0 * (-d_u_tmp * a_tmp * b_Ts1_tmp / 2.0 + yr_tmp_tmp * param[0]) *
             a_tmp) *
            Ts1_tmp_tmp) +
       2.0 * param[2] * c_u_tmp * b_Ts1_tmp_tmp * b_Ts1_tmp * param[0] *
           a_tmp) /
      a_tmp / Ts1_tmp_tmp / b_Ts1_tmp_tmp;
  u[2] =
      ((((param[2] * rt_powd_snf(b_Ts1_tmp_tmp, 4.0) * Ts1_idx_1 * param[0] *
              n3pp -
          param[2] * b_u_tmp * param[0] *
              (Ts1_tmp_tmp * b_Ts1_tmp * n2 - Ts1_tmp * n1) * yr_tmp) +
         3.0 * param[2] *
             (((e_u_tmp * Ts1_idx_1 / 3.0 +
                ((c_yr_tmp * n3 + (-c_u_tmp - b_yr_tmp) * param[3]) -
                 n3pp / 3.0) *
                    b_n1_tmp) -
               0.66666666666666663 * x[9] * Ts1_tmp_tmp * Ts1_tmp * n3p) -
        ...
        4.0 * Ts1_tmp_tmp *
            (b_Ts1_idx_1_tmp * Ts1_tmp_tmp * b_Ts1_tmp * param[0] * n3p / 2.0 +
             (yr_tmp_tmp * b_Ts1_tmp * param[0] - d_u_tmp * a_tmp / 4.0) *
                 a_tmp) *
            b_Ts1_tmp_tmp) -
